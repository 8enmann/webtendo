...
/***/ function(module, exports, __webpack_require__) {
	...
	var _client = __webpack_require__(68);

	var client = _interopRequireWildcard(_client);

	var _joystick = __webpack_require__(69);

	var joystick = _interopRequireWildcard(_joystick);
	...
	client.callbacks.onTouch = function (e, touch, region) {
	  ...
	  if (region === 'stick') {
	    ...
	    if (e.type === 'touchend') {
	      ...
	      position = joystick.moveStick(touch.pageX - joystickElement.offsetLeft, touch.pageY - joystickElement.offsetTop);
	    }
	    client.sendToHost({
	      action: e.type,
	      value: region,
	    ...
	    if (e.type === 'touchmove' || !region) {
	      // break early
	      return;
	    }
	    var params = {};
	    _underscore2.default.each(region.split(','), function (a) {
	      var b = a.split('=');
	      params[b[0]] = b[1];
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var webtendo = __webpack_require__(1);
